...
% !TeX root = modelo-latex-para-filosofos.tex
% !TeX encoding = UTF-8
...
\usepackage{relsize} % precisa ser readicionado por que senão o comando \part não funciona no biblatex. Ver problemas em aberto em:  <https://github.com/abntex/abntex2/issues/109>
\usepackage{pdfpages} % para incluir páginas pdf diretamente no documento

% --- Utilizando o estilo biblatex-abnt
\usepackage[backend=biber,style=abnt-ibid,sccite,citecount,ittitles,scbib,justify,noslsn,repeatfields]{biblatex}
...
% ---
\titulo{Modelo de trabalho acad{\^e}mico (monografia, dissertação, tese) com \abnTeX~ para estudantes da UFOP}
\autor{Estudante}
\local{Ouro Preto}
\data{\today}
\orientador{prof. James Clerk Maxwell, PhD.}
\coorientador{prof. Claude-Henri Gorceix, Dr.}
...
\preambulo{Monografia apresentada ao Curso XXX da Universidade Federal de Ouro Preto como parte dos requisitos para a obten{\c c}{\~a}o do Grau de Mestre em XXXX.}
% ---
