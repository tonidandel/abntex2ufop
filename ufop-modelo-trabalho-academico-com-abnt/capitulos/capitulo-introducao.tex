...
Uma outra citação nada a ver.\footcite[E como sabermos, Herão é um dos pioneiros das máquinas a vapor. Sua invenção, nem por isso, provocou uma revoluçaõ industrial no primeiro século. Cf.][12]{herao}

\caixa{
	O autor não é obrigado a seguir as notas explicativas,\footcite{boyle1772} e pode utilizar o estilo autor-data igualmente, mas deve seguir o mesmo padrão ao longo do texto. Por exemplo, pode ser no formato autor-data, como \cite{descartes-oeuvres-volx} ou se quiser apenas o autor, como \citeauthor[][12]{descartes-oeuvres-volx}, ou ainda, se quiser imprimir apenas a data de referida obra, como \citedate[][55]{descartes-oeuvres-volx}.
}
