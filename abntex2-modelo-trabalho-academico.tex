...
% ---
\titulo{Modelo de Trabalho Acadêmico com \abnTeX ~ajustado {\`a}s normas do CECAU - UFOP}
\autor{Aluno da UFOP}
\local{Ouro Preto}
\data{2015}
...
% 
   ...
   \vspace*{\fill}
   \assinatura{\textbf{Professor Fulano, PhD.} \\ Convidado 1}
   \vspace*{\fill}
   \assinatura{\textbf{Professor Ciclano, Dr.} \\ Convidado 2}
   \vspace*{\fill}
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
		\textit{``O corpo {\'e} o transdutor do espírito.'' (Dr. S{\'e}rgio Felipe de Oliveira)}
	\end{flushright}
\end{epigrafe}
% ---
...
\begin{resumo}
 \noindent Segundo a \citeonline[3.1-3.2]{NBR6028:2003}, o resumo deve ressaltar o objetivo, o método, os resultados e as conclusões do documento. A ordem e a extensão
